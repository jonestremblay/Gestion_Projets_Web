...
<!-- Valider les champs saisis -->
        function valider() 
            ...
            {
            var valide = true;
            if ($("input#titre").val() == "" || $("input#aPropos").val() == "" ||
                    $("input#cle").val() == "" || $("input#annee").val() == ""
                    || $("input#session").val() == "") {
                    alert("Renseigner tout les champs");
                    valide = false;
                }else if  (isNaN($("input#annee").val())){
                    alert("Entrez uniquement une valeur numérique pour annee");
                }
                return valide;
            }
                    $(document).ready(function ()
                    {
                        ...
                        titre: $("input#titre").val(),
                                aPropos: $("input#aPropos").val(),
                                cle: $("input#cle").val(),
                                annee: $("input#annee").val(),
                                session: $("#session").val(),
...
<nav class="sidebar col-md-3 col-lg-2">
    <div id="sidebarMenu" class="position-sticky pt-4">
        ...
        <ul class="nav nav-pills flex-column nav-fill">
            ...
            <li class="row nav-item">
                <a class="nav-link" href="ControleurRedirection?goToPage=cours/voirCours" >
                    <span class="fas fa-plus-circle fa-lg mx-4 " style="float: left; position: relative; top :5px;"></span>
                    <span style="float: right;">
                        ...
                        <div class="content container-fluid ">
                            ...
                            <div class="container-body col-4">
                                <div class="container-form">
                                    <h4 class="title-team">Création de cours</h4>


                                    <h5>Titre du cours</h5><input type="text" name="titre" id="titre" class="cours_champ" />
                                    <br />

                                    <h5>Description du cours</h5>


                                    <input type="text" name="aPropos" id="aPropos" class="cours_champ" />
                                    <br />
                                    <h5>
                                        Clé du cours
                                    </h5>

                                    <input type="text" name="cle" id="cle" class="cours_champ" />
                                    <br />
                                    <h5>
                                        Année
                                    </h5>

                                    <input type="number" min="2021" max="2025" name="annee" id="annee" class="cours_champ" />
                                    <br />
                                    <h5>
                                        Session
                                    </h5>
                                    ...
                                    <select  name="session" id="session" class="cours_champ">

                                        <option value="Automne">Automne</option>
                                        <option value="Hiver">Hiver</option>
                                        <option value="Eté">Eté</option>
                                    </select>
                                    <input type="hidden" name="courriel" id="courriel" value=<%@include file="fragmentUser.jspf"%> />
                                    <br />
                                    <button class="cours_champ">creer un cours</button>
