        ...
        <nav class="sidebar col-md-3 col-lg-2">
            <div id="sidebarMenu" class="position-sticky pt-4">
                ...
                <ul class="nav nav-pills flex-column nav-fill">
                    ...
                    <li class="row nav-item">
                        <a class="nav-link" href="ControleurRedirection?goToPage=equipes/voirEquipes" >
                            <span class="fas fa-plus-circle fa-lg mx-4 " style="float: left; position: relative; top :5px;"></span>
                            <span style="float: right;">
        ...
        <div class="content container-fluid">
            <div class="container-body col-4">
                <div class="container-form">
                    <h3 class="title-team">Ajouter étudiants à mon équipe</h3>
                    <form  action=""  method="post">
                        <div class="mb-3">
                           <select id="titreCours" name="nomCours" class="form-select" aria-label="select example" onchange="initEquipeEtudiants()" required> 
                            ...
                            <br>
                            <select id="equipeCours" name="etudiantCours" class="form-select" aria-label="select example" required>
                                <option selected >-------Choissisez une équipe-------</option>                
                            </select>
                           <br>
                            <select id="coursEtudiant" class="form-select" aria-label="select example" required>
                                <option selected >-------Choissisez un étudiant-------</option>
                            </select>
                            
                        </div>
                        <div class="mb-3 ajouterEtudiant">
                            <button class="btn btn-outline-secondary  btn-lg" onclick="verifierSiEtudiantDejaEquipe()" type="submit" >Ajouter étudiant</button>
                        </div>
                    </form>
                </div>
            </div>
