        ...
        <div class="content container-fluid">
            <div class="container-body col-4">
                <div class="container-form">
                    <h3 class="title-team">Créer une nouvelle équipe</h3>
                    <form action="ControleurCreationEquipe">
                        <div class="mb-3">
                            <select id="titreCours" name="nomCours" class="form-select"  required aria-label="select example">
                            ...
                            <br>    
                            <input id="nomEquipe" name="nomEquipe" type="text"  placeholder="Nom équipe" id="validationServer01" value="" required>
                            <br>
                            <div class="col-12">
                                <button class="btn btn-outline-secondary  btn-lg nouvelleEquipe" type="submit" onclick="validerChamps()">Créer équipe</button>
                            </div>
                    </form>
                </div>
            </div>
